...
import { PiArrowLeftLight,  PiClock} from "react-icons/pi";
    ...
    <Container>
      ...
      <main>
        <Content>
              ...
              <Section>
                <h1>Interestellar</h1>
                <div><img src="src\assets\stars.png" alt="" /></div>
              </Section>

             <Section>
                <img src="https://github.com/Isabelle-Vicente.png" alt="" />
                <p>Isabelle Vicente </p>
                <PiClock />
           ...
           <Section>
              ...
              <p>
              Além de Cooper, a tripulação da Endurance é formada pela bióloga Amelia, filha de Brand; o cientista Romilly, o físico planetário Doyle, além dos robôs TARS e CASE. Eles entram no buraco de minhoca e se dirigem a Miller, 
